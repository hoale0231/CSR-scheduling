...
def CSR_required_week(week_requires: List[List[int]], shifts: List[List[int]] = SHIFTS,  minimum_day_off: int = MINIMUM_DAY_OFF) -> Tuple[int, List[int], List[List[int]]]:
    """
    ...
    """
    num_csr_each_day, week_schedule = CSR_required_each_day(week_requires, shifts) # nc, week_schedule = [nc_1, nc_2, ..., nc_J], week_schedule
...
if __name__ == '__main__':
    minimum_csr, num_csr_each_day, week_schedule = CSR_required_week(REQUIRES, SHIFTS, MINIMUM_DAY_OFF)
